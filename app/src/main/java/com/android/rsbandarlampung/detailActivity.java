...
public class detailActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    TextView name, address, phone, ket, jenis, kelas, medis, perawat, kamarTotal, kamarTerpakai, kamarTersedia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kamarTotal = findViewById(R.id.tvKamarTotal);
        kamarTerpakai = findViewById(R.id.tvKamarTerpakai);
        kamarTersedia = findViewById(R.id.tvKamarTersedia);
        ...
        kamarTotal.setText(in.getStringExtra("kamarTotal"));
        kamarTerpakai.setText(in.getStringExtra("kamarTerpakai"));
        kamarTersedia.setText(in.getStringExtra("kamarTersedia"));
