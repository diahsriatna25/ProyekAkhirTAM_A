    ...
    public void onBindViewHolder(@NonNull bedAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("kamarTotal", data.get(position).getKamarTotal());
                i.putExtra("kamarTerpakai", data.get(position).getKamarTerpakai());
                i.putExtra("kamarTersedia", data.get(position).getKamarTersedia());
                ca.startActivity(i);
            }
        });
    }
